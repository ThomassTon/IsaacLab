...
from omni.isaac.lab_assets.tiago import TIAGO_CFG

@configclass
class TiagoCubeLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        ...
        #     asset_name="robot", joint_names=["base.*"]
        # )
        self.actions.gripper_action = mdp.BinaryJointPositionActionCfg(
            asset_name="robot",
            joint_names=["gripper_left.*"],
            open_command_expr={"gripper_left.*": 0.04},
